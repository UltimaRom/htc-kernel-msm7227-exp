/* linux/arch/arm/mach-msm/board-marvel-wifi.c
*/
...
int marvel_wifi_power(int on);
int marvel_wifi_reset(int on);
int marvel_wifi_set_carddetect(int on);
...
static void *marvel_wifi_mem_prealloc(int section, unsigned long size)
{
...
int __init marvel_init_wifi_mem(void)
{
	int i;
...
static struct resource marvel_wifi_resources[] = {
	[0] = {
...
static struct wifi_platform_data marvel_wifi_control = {
	.set_power = marvel_wifi_power,
	.set_reset = marvel_wifi_reset,
	.set_carddetect = marvel_wifi_set_carddetect,
	.mem_prealloc = marvel_wifi_mem_prealloc,
...
static unsigned marvel_wifi_update_nvs(char *str)
{
...
static int __init marvel_wifi_init(void)
{
	int ret;
...
device_initcall(marvel_wifi_init);
